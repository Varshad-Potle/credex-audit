    ...
    try {
        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
          ...
          <p style="color: #555;">
            ...
            href="${auditUrl}"
            style="display: inline-block; background: #2563eb; color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 500; margin: 16px 0;"
          >
            View Full Audit Report →
          </a>
          <p style="color: #555;">
            If you&apos;re seeing significant savings opportunities, our team at Credex can help you
